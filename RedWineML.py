''' changing the trainig size and testing size may change the success rate , for training = 1097 and testing = 500 , sucess rate is 58.8% '''
...
def main():
  data = data_extracting('RedWineData.txt')
  X=parameters(data)
  Y=results(data)
  #print(" training set ")
  #print(X)        
  X_app,X_test,y_app,y_test = cross_validation.train_test_split(X,Y,test_size =500,train_size=1097,random_state=0)
